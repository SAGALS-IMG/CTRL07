...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.Buttons, Vcl.ExtCtrls,
   Vcl.ComCtrls, SelShape, Math, Unit_LP,ClipBrd, IniFiles;
...
procedure TForm_Ph_PW.FormCreate(Sender: TObject);
var
  Ini: TIniFile;
  TmpKey : WORD;
...
begin
  ...
  try
    Top     := Ini.ReadInteger( 'Form_Ph_PW', 'Top', 100 );
    Left    := Ini.ReadInteger( 'Form_Ph_PW', 'Left', 100 );
    Width   := Ini.ReadInteger( 'Form_Ph_PW', 'Width', 750 );
    Height  := Ini.ReadInteger( 'Form_Ph_PW', 'Height', 500 );
    if Ini.ReadBool( 'Form_Ph_PW', 'InitMax', false ) then
      WindowState := wsMaximized
    else
      WindowState := wsNormal;

    Edit_PMin.Text := Ini.ReadString('Form_Ph_PW', 'PMin', '0' );
    Edit_PMax.Text := Ini.ReadString('Form_Ph_PW', 'PMax', '10000' );

    Edit_Left.Text := Ini.ReadString('Form_Ph_PW', 'ROI_Left', '100' );
    Edit_Top.Text := Ini.ReadString('Form_Ph_PW', 'ROI_Top', '100' );
    Edit_Right.Text := Ini.ReadString('Form_Ph_PW', 'ROI_Right', '300' );
    Edit_Bottom.Text := Ini.ReadString('Form_Ph_PW', 'ROI_Bottom', '300' );

    CB_Mag.ItemIndex := Ini.ReadInteger('Form_Ph_PW', 'Mag', 0 );
...
procedure TForm_Ph_PW.FormDestroy(Sender: TObject);
var
  Ini: TIniFile;
begin
  Ini := TIniFile.Create( ChangeFileExt( Application.ExeName, '.INI' ) );
  try
    Ini.WriteInteger( 'Form_Ph_PW', 'Top', Top);
    Ini.WriteInteger( 'Form_Ph_PW', 'Left', Left);
    Ini.WriteInteger( 'Form_Ph_PW', 'Width', Width );
    Ini.WriteInteger( 'Form_Ph_PW', 'Height', Height );

    Ini.WriteBool( 'Form_Ph_PW', 'InitMax', WindowState = wsMaximized );

    Ini.WriteString('Form_Ph_PW', 'PMin', Edit_PMin.Text );
    Ini.WriteString('Form_Ph_PW', 'PMax', Edit_PMax.Text );

    Ini.WriteString('Form_Ph_PW', 'ROI_Left', Edit_Left.Text);
    Ini.WriteString('Form_Ph_PW', 'ROI_Top',  Edit_Top.Text );
    Ini.WriteString('Form_Ph_PW', 'ROI_Right', Edit_Right.Text);
    Ini.WriteString('Form_Ph_PW', 'ROI_Bottom',Edit_Bottom.Text);
    Ini.WriteInteger('Form_Ph_PW', 'Mag', CB_Mag.ItemIndex);
  finally
    Ini.Free;
  end;
end;

procedure TForm_Ph_PW.BB_ImgCopyClick(Sender: TObject);
var
  lMag :longint;
  bm: TBitmap;
begin
...
procedure TForm_Ph_PW.CB_MagChange(Sender: TObject);
begin
  Draw_Data(Sender);
end;

procedure TForm_Ph_PW.UD_NoClick(Sender: TObject; Button: TUDBtnType);
begin
  PData := SData[UD_No.Position];
  Draw_Data(Sender);
end;


procedure TForm_Ph_PW.Draw_Data(Sender: TObject);
var
  i,j,TmpInt:longint;
  P:PByteArray;
  Bitmap : TBitMap;
...
procedure TForm_Ph_PW.Edit_LeftKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  lMag:longint;
begin
...
procedure TForm_Ph_PW.Edit_PMaxKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  lNum : double;
  lCode : longint;
begin
  Val((Sender as TEdit).Text,lNum,lCode);
  if lCode=0 then
    Draw_Data(Sender);
end;

procedure TForm_Ph_PW.Image1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  i:longint;
  lMag : longint;
...
procedure TForm_Ph_PW.Image1MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
var
  lMag : longint;
begin
...
procedure TForm_Ph_PW.SSMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
var
  lMag:longint;
begin
...
procedure TForm_Ph_PW.Add_Img(var Img1, Img2: TData);
var
  j,i:longint;
begin
  for j:=0 to PH-1 do
...
procedure TForm_Ph_PW.Subst_Img(var Img1, Img2: TData);
var
  j,i:longint;
begin
  for j:=0 to PH-1 do
...
procedure TForm_Ph_PW.Th_img(var Img: TData; Th: double);
var
  j,i:longint;
begin
...
procedure TForm_Ph_PW.DivS_Img(var Img1: TData;f:double);
var
  j,i:longint;
begin
  for j:=0 to PH-1 do
...
procedure TForm_Ph_PW.Div_Img(var Img1, Img2: TData);
var
  j,i:longint;
begin
  for j:=0 to PH-1 do
...
procedure TForm_Ph_PW.Bin_Img(var Img: TData);
var
  j,i,jj,ii:longint;
  TmpDbl : double;
begin
...
procedure TForm_Ph_PW.Gauss_Smooth_Img(var Img:TData);
var
  i,j,ii,jj:longint;
  TmpDbl : double;
begin
...
procedure TForm_Ph_PW.Lap_Edge_Img(var Img: TData);
var
  i,j,ii,jj:longint;
  TmpDbl : double;
begin
...
procedure TForm_Ph_PW.Ln_Img(var Img1: TData);
var
  j,i:longint;
begin
  for j:=0 to PH-1 do
...
procedure TForm_Ph_PW.Load_Data(FN:string;Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
...
procedure TForm_Ph_PW.Load_ImgData(FN: string; Sender: Tobject);
var
  i,j:longint;
  P:PByteArray;
begin
...
procedure TForm_Ph_PW.Load_SglData(FN: string; Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
...
procedure TForm_Ph_PW.Load_ByteData(FN:string;Header:byte;Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
...
procedure TForm_Ph_PW.Load_Byte_TIFFData(FN: string; Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
  lData : array[0..4100] of Byte;
...
procedure TForm_Ph_PW.Load_STIFFData(FN: string; Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
...
procedure TForm_Ph_PW.Load_TIFFData(FN: string; Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
...
procedure TForm_Ph_PW.Load_WORDData(FN: string; Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
  lData : array[0..4100] of WORD;
...
procedure TForm_Ph_PW.Median_Hol_Img(var Img: TData);
var
...
procedure TForm_Ph_PW.Median_Img(var Img: TData);
var
  i,j,ii,jj,k, lPW, lPH:longint;
  SData : array[0..10] of double;
...
procedure TForm_Ph_PW.Median_Img2(var Img: TData);
var
  i,j,ii,jj,k, lPW, lPH:longint;
  SData : array[0..10] of double;
...
procedure TForm_Ph_PW.Normalize_Img(var Img: TData);
var
  i,j:longint;
...
procedure TForm_Ph_PW.Save_Data(FN: string; Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
  lData : array[0..4100] of double;
...
procedure TForm_Ph_PW.Save_IntData(FN: string; Sender: Tobject);
var
  i,j : longint;
  FS : TFileStream;
  lData : array[0..4100] of WORD;
